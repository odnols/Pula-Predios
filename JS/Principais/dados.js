...
function apagaDados(valor){
    ...
    if(valor){
        ...
        localStorage.removeItem("qtdMods");
        localStorage.removeItem("tempoFlutuando");
        ...
        localStorage.removeItem("moedasGastas");
        localStorage.removeItem("moedasColetadas");

        localStorage.removeItem("eventosConcluidos");
        localStorage.removeItem("tempoEventos");
        localStorage.removeItem("qtdEventoCidade");
        localStorage.removeItem("qtdEventoParque");
        localStorage.removeItem("qtdEventoAgua");
        localStorage.removeItem("qtdEventoLava");

        localStorage.removeItem("lista_conquistas_ganhas");
        localStorage.removeItem("skinAtual");
        localStorage.removeItem("skinsCompradas");
        localStorage.removeItem("modsComprados");
        localStorage.removeItem("modsCompradosUsados");
        localStorage.removeItem("modEmUso");
        localStorage.removeItem("bonusComprados");
        localStorage.removeItem("bonusVezesUsados");

        localStorage.removeItem("tt_skins_compradas"); 
        localStorage.removeItem("tt_mods_comprados");
        localStorage.removeItem("tt_bonus_comprados");
