function desenha_chao1() {
    ...
    if (eventos.evento == 1 && chao.muda_chao[2] != 0 && chao.reserva[2] < 2) {
        ...
        transitador("agua_noite", 66, chao.x2 + opcoes.largura, chao.y + 10)
        ...
        transitador("chao_noite", 46, chao.x2 + opcoes.largura, chao.y - 5)
    }
    ...
    if (chao.muda_chao[2] == 2 || chao.libera_volta_chao[2] == 1 && chao.trava[2] == 0) {
        if (chao.reserva[2] <= 1) {
            if (eventos.ultimo_evento == 1) {
                ...
                transitador("agua_noite", 66, chao.x2, chao.y + 10)
...
function desenha_chao2() {
    ...
    if (chao.muda_chao[1] != 0 && chao.reserva[1] < 2 && jogo.status != estados.ocioso) {
        if (eventos.evento == 1) {
            ...
            transitador("agua_noite", 66, chao.x + opcoes.largura, chao.y + 22)
        ...
        transitador("chao_noite", 46, chao.x + opcoes.largura, chao.y + 10)
    }
    ...
    if (chao.muda_chao[1] == 2 || chao.libera_volta_chao[1] == 1 && chao.trava[1] == 0) {
        if (chao.reserva[1] <= 1 && jogo.status != estados.ocioso) {
            if (eventos.ultimo_evento == 1) {
                ...
                transitador("agua_noite", 66, chao.x, chao.y + 22)
...
function desenha_chao3() {
    ...
    if (chao.muda_chao[0] != 0 && chao.reserva[0] < 2) {
        if (eventos.evento == 1) {
            ...
            transitador("agua_noite", 66, chao.x3 + opcoes.largura, chao.y + 40)
        ...
        transitador("chao_noite", 46, chao.x3 + opcoes.largura, chao.y + 27)
    }
    ...
    if (chao.muda_chao[0] == 2 || chao.libera_volta_chao[0] == 1 && chao.trava[0] == 0) {
        if (chao.reserva[0] <= 1) {
            if (eventos.ultimo_evento == 1) {
                ...
                transitador("agua_noite", 66, chao.x3, chao.y + 40)
            }
