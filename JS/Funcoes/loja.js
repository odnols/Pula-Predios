...
function carrega_vendas_loja(caso){
    ...
    if(caso == "Skins"){
        ...
        if(jogador.skin != 7)
            document.getElementById("placeholder_loja").innerHTML += "<div class='item_comprado' onclick='confirma_compra(1, 7)'><img class='img_skin_venda' src='Imagens/Loja/Skins/Jogador7_noite.png'><br><br>Padrão</div>";
        else
        ...
        for(var i = 0; i < 6; i++){
            if(jogador.skins_compradas[i] != 1) // Item a venda
                ...
                document.getElementById("placeholder_loja").innerHTML += "<div class='item_comprado' onclick='confirma_compra(1, "+ i +", 55)'><img class='img_skin_venda' src='Imagens/Loja/Skins/Jogador"+ (i + 1) +"_noite.png'><br><br>"+ nomeSkins[i] +"</div>";
            else                         // Item Equipado
                document.getElementById("placeholder_loja").innerHTML += "<div class='item_equipado' onclick='confirma_compra(1, "+ i +", 55)'><img class='img_skin_venda' src='Imagens/Loja/Skins/Jogador"+ (i + 1) +"_noite.png'><br><br>"+ nomeSkins[i] +"</div>";
        }
