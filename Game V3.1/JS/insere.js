...
//  Aumenta a Velocidade Gradualmente
    if(obstaculos.qtdObjetos % 6 == 0 && estadoAtual == estados.jogando && velocidade_obs < 35 && jogo.dificuldade != 3)
        velocidade_obs++;

    if(obstaculos.qtdObjetos % 4 == 0 && estadoAtual == estados.jogando && velocidade_obs < 45 && jogo.dificuldade == 3)
        velocidade_obs++;
}
