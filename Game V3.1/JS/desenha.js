        ...
        if(obsb.altura >= 55){
            if(obsb.altura > 80){
                if(obsb.altura > 110){ // Amarelo
                    spritePredio2_1.desenha(obsb.x, chao.y - obsb.altura + 50, obsb.largura, obsb.altura);
                    transitador("predio2_1", 100, obsb.x, chao.y - obsb.altura + 48, obsb.largura, obsb.altura);
                }else if(obsb.altura > 100){ // Vermelho
                    spritePredio1_1.desenha(obsb.x, chao.y - obsb.altura + 25, obsb.largura, obsb.altura);
                    transitador("predio1_1", 100, obsb.x - 1, chao.y - obsb.altura + 23, obsb.largura, obsb.altura);
                }else if(obsb.altura > 90){ // Amarelo com Antena
                    spritePredio2_2.desenha(obsb.x, chao.y - obsb.altura + 25, obsb.largura, obsb.altura);
                    transitador("predio2_2", 100, obsb.x, chao.y - obsb.altura + 15, obsb.largura, obsb.altura);
                }else{ // Vermelho com Antena
                    spritePredio1_2.desenha(obsb.x, chao.y - obsb.altura + 25, obsb.largura, obsb.altura);
                    transitador("predio1_2", 100, obsb.x, chao.y - obsb.altura + 15, obsb.largura, obsb.altura);
                }
            }else if(obsb.altura >= 60){
                spritePredio3.desenha(obsb.x, chao.y - obsb.altura + 25 , obsb.largura, obsb.altura);
                transitador("predio3", 100, obsb.x - 1, chao.y - obsb.altura + 24, obsb.largura, obsb.altura);
...
function desenha_propsfrente(){
    ...
    if(estadoAtual == estados.jogando || estadoAtual == estados.jogar || estadoAtual == estados.ocioso)
